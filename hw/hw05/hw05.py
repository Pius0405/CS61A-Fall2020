class VendingMachine:
    ...
    def vend(self):
        ...
        change = self.fund - self.product_price
        if change >= 0:
            self.inventory -= 1
            self.fund = 0
...
class Coin:
    ...
    def worth(self):
        ...
        return (self.cents + age-50) if age-50 > 0 else self.cents
...
def store_digits(n):
    ...
    if n < 10:
        ...
        item, remaining = helper(n)
        return Link(item, store_digits(remaining))
...
def is_bst(t):
    ...
    if t.is_leaf():
        ...
        #as long as the only branch is a valid bst, assume that is is at the correct position (L/R)
