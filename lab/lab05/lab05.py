...
def add_trees(t1, t2):
    ...
    new_branches = [add_trees(branches[0],branches[1]) for branches in zip(branches(t1),branches(t2))]
    new_branches += branches(t1)[len(new_branches):] + branches(t2)[len(new_branches):]
